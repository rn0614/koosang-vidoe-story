...
const FlowEditorContent = () => {
  ...
  const { addNode, getAllNodeIds, getNode, getConnections, replaceAll, currentTemplateId, setCurrentTemplateId } = useWorkflowContext();
  ...
  }, [fetchTemplates, replaceAll, setCurrentTemplateId]);
  ...
  }, [workflowTitle, currentTemplateId, getAllNodeIds, getNode, getConnections]);
